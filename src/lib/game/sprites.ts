...
const SKIN_PRESETS: Record<string, SkinStyle[]> = {
  knight: [
    ...
    { filter: 'hue-rotate(45deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  paladin: [
    {},
    ...
    { filter: 'hue-rotate(20deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  berserker: [
    {},
    ...
    { filter: 'hue-rotate(0deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  samurai: [
    {},
  ...
  monk: [
    ...
    { filter: 'hue-rotate(120deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  archer: [
    {},
  ...
  assassin: [
    ...
    { filter: 'hue-rotate(270deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  mage: [
    {},
    ...
    { filter: 'hue-rotate(90deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  druid: [
    {},
    ...
    { filter: 'hue-rotate(260deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  necromancer: [
    {},
    ...
    { filter: 'hue-rotate(280deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  summoner: [
    {},
    ...
    { filter: 'hue-rotate(120deg) saturate(1.3)', accessory: 'leaf-crown', aura: 'nature' },
    { filter: 'hue-rotate(150deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  alchemist: [
    {},
    ...
    { filter: 'hue-rotate(200deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  chronomancer: [
    {},
    ...
    { filter: 'hue-rotate(60deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' },
  ],
  beastmaster: [
    {},
  ...
  ninja:       [{}, { filter: 'hue-rotate(0deg) saturate(1.4) brightness(1.05)', accessory: 'cape-red', aura: 'fire' }, { filter: 'hue-rotate(180deg) saturate(1.3)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'hue-rotate(270deg) saturate(1.4)', accessory: 'cape-purple', aura: 'arcane' }, { filter: 'hue-rotate(45deg) saturate(1.6) brightness(1.1)', accessory: 'crown', aura: 'gold' }, { filter: 'hue-rotate(300deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  pyromancer:  [{}, { filter: 'hue-rotate(-20deg) saturate(1.5) brightness(1.15)', accessory: 'horns', aura: 'fire' }, { filter: 'hue-rotate(30deg) saturate(1.4)', accessory: 'crown', aura: 'gold' }, { filter: 'saturate(0.5) brightness(0.9)', accessory: 'cape-purple', aura: 'shadow' }, { filter: 'hue-rotate(180deg) saturate(1.2)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'hue-rotate(-10deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  cryomancer:  [{}, { filter: 'hue-rotate(180deg) saturate(1.4)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'hue-rotate(220deg) saturate(1.3) brightness(1.1)', accessory: 'crown', aura: 'arcane' }, { filter: 'hue-rotate(120deg) saturate(1.2)', accessory: 'leaf-crown', aura: 'nature' }, { filter: 'hue-rotate(40deg) saturate(1.4) brightness(1.1)', accessory: 'halo', aura: 'gold' }, { filter: 'hue-rotate(190deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  stormcaller: [{}, { filter: 'hue-rotate(240deg) saturate(1.4)', accessory: 'cape-purple', aura: 'arcane' }, { filter: 'hue-rotate(60deg) saturate(1.3) brightness(1.1)', accessory: 'crown', aura: 'gold' }, { filter: 'hue-rotate(180deg) saturate(1.3)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'saturate(0.4) brightness(0.9)', accessory: 'horns', aura: 'shadow' }, { filter: 'hue-rotate(210deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  geomancer:   [{}, { filter: 'hue-rotate(30deg) saturate(1.4)', accessory: 'cape-gold', aura: 'gold' }, { filter: 'hue-rotate(120deg) saturate(1.3)', accessory: 'leaf-crown', aura: 'nature' }, { filter: 'hue-rotate(-30deg) saturate(1.5) brightness(1.1)', accessory: 'horns', aura: 'fire' }, { filter: 'saturate(0.5) brightness(0.85)', accessory: 'pauldrons-bone', aura: 'shadow' }, { filter: 'hue-rotate(45deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  bard:        [{}, { filter: 'hue-rotate(300deg) saturate(1.4)', accessory: 'cape-purple', aura: 'arcane' }, { filter: 'hue-rotate(60deg) saturate(1.3) brightness(1.1)', accessory: 'crown', aura: 'gold' }, { filter: 'hue-rotate(180deg) saturate(1.3)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'hue-rotate(120deg) saturate(1.3)', accessory: 'leaf-crown', aura: 'nature' }, { filter: 'hue-rotate(280deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  gunner:      [{}, { filter: 'hue-rotate(-20deg) saturate(1.5) brightness(1.1)', accessory: 'cape-red', aura: 'fire' }, { filter: 'hue-rotate(180deg) saturate(1.3)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'hue-rotate(40deg) saturate(1.4) brightness(1.1)', accessory: 'crown', aura: 'gold' }, { filter: 'saturate(0.4) brightness(0.85)', accessory: 'mask', aura: 'shadow' }, { filter: 'hue-rotate(10deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  templar:     [{}, { filter: 'hue-rotate(45deg) saturate(1.5) brightness(1.15)', accessory: 'halo', aura: 'gold' }, { filter: 'hue-rotate(-30deg) saturate(0.6) brightness(0.85)', accessory: 'cape-purple', aura: 'shadow' }, { filter: 'hue-rotate(180deg) saturate(1.2)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'hue-rotate(-15deg) saturate(1.4)', accessory: 'cape-red', aura: 'fire' }, { filter: 'hue-rotate(50deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  warlock:     [{}, { filter: 'hue-rotate(-60deg) saturate(0.5) brightness(0.85)', accessory: 'horns', aura: 'shadow' }, { filter: 'hue-rotate(-20deg) saturate(1.5) brightness(1.05)', accessory: 'cape-red', aura: 'fire' }, { filter: 'hue-rotate(120deg) saturate(1.3)', accessory: 'leaf-crown', aura: 'nature' }, { filter: 'hue-rotate(240deg) saturate(1.4)', accessory: 'crown', aura: 'arcane' }, { filter: 'hue-rotate(270deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
  valkyrie:    [{}, { filter: 'hue-rotate(45deg) saturate(1.4) brightness(1.15)', accessory: 'halo', aura: 'gold' }, { filter: 'hue-rotate(180deg) saturate(1.3)', accessory: 'cape-blue', aura: 'ice' }, { filter: 'hue-rotate(-20deg) saturate(1.4)', accessory: 'cape-red', aura: 'fire' }, { filter: 'saturate(0.5) brightness(0.85)', accessory: 'cape-purple', aura: 'shadow' }, { filter: 'hue-rotate(40deg) saturate(1.8) brightness(1.3) contrast(1.1)', accessory: 'legendary-crown', aura: 'legendary' }],
}
...
export const SKIN_NAMES: Record<CharacterClass, string[]> = {
  knight:      ['Guarda Real', 'Cruzado Azul', 'Cavaleiro Sombrio', 'Rei Dourado', 'Cavaleiro de Fogo', 'Lendário: Rei Dragão Dourado'],
  paladin:     ['Templário', 'Justiceiro Dourado', 'Penitente Sombrio', 'Cruzado de Gelo', 'Arconte Arcano', 'Lendário: Lorde Solar Divino'],
  berserker:   ['Bárbaro do Norte', 'Viking de Gelo', 'Lorde da Carnificina', 'Caçador de Ossos', 'Druida Selvagem', 'Lendário: Colosso de Lava'],
  samurai:     ['Samurai Imperial', 'Ronin Dourado', 'Shinobi Sombrio', 'Lâmina de Gelo', 'Demônio Oni', 'Lendário: Shogun Celestial'],
  monk:        ['Monge da Montanha', 'Discípulo do Dragão', 'Mestre do Fogo', 'Eremita da Floresta', 'Sábio Iluminado', 'Lendário: Mestre Dragão Dourado'],
  archer:      ['Caçador da Mata', 'Patrulheiro Real', 'Elfo da Floresta', 'Espreitador Sombrio', 'Arqueiro Polar', 'Lendário: Guardião Esmeralda'],
  assassin:    ['Ladrão da Sombra', 'Espião Arcano', 'Lâmina Sangrenta', 'Assassino de Gelo', 'Demônio Noturno', 'Lendário: Sombra Imperial'],
  mage:        ['Arcanista', 'Mago do Sol', 'Druida Místico', 'Necromante Iniciado', 'Mago do Gelo', 'Lendário: Arquimago Astral'],
  druid:       ['Guardião do Bosque', 'Xamã Ancestral', 'Druida do Fogo', 'Druida do Gelo', 'Druida Sombrio', 'Lendário: Espírito da Natureza'],
  necromancer: ['Lich Iniciado', 'Necro-Druida', 'Senhor das Chamas', 'Profeta Dourado', 'Lich do Gelo', 'Lendário: Lich Real (Grátis)'],
  summoner:    ['Conjurador Arcano', 'Místico Sombrio', 'Oráculo Dourado', 'Eremita Espiritual', 'Druida Espectral', 'Lendário: Senhor dos Espíritos'],
  alchemist:   ['Alquimista do Jade', 'Boticário da Natureza', 'Pirotécnico', 'Sábio do Gelo', 'Bruxo das Misturas', 'Lendário: Alquimista Supremo'],
  ninja:        ['Ninja Sombra', 'Ninja Crimson', 'Ninja Glacial', 'Ninja Tempestade', 'Ninja Dourado', 'Lendário: Ninja Celestial'],
  pyromancer:   ['Piromante Carmesim', 'Piromante Fenix', 'Piromante Magma', 'Piromante Solar', 'Piromante Sombrio', 'Lendário: Senhor das Chamas Eternas'],
  cryomancer:   ['Criomante Glacial', 'Criomante Ártico', 'Criomante Cristal', 'Criomante Lunar', 'Criomante Tempestade', 'Lendário: Imperador do Inverno'],
  stormcaller:  ['Invocador da Tempestade', 'Trovejante', 'Mestre dos Raios', 'Furacão Vivo', 'Senhor da Chuva', 'Lendário: Deus do Trovão'],
  geomancer:    ['Geomante de Pedra', 'Geomante de Lava', 'Geomante de Cristal', 'Geomante Esmeralda', 'Geomante Titã', 'Lendário: Titã da Terra'],
  bard:          ['Bardo Errante', 'Trovador Real', 'Cantor das Sombras', 'Bardo de Cristal', 'Bardo Carmesim', 'Lendário: Maestro Celestial'],
  gunner:        ['Pistoleiro Errante', 'Pistoleiro Real', 'Pistoleiro Sombrio', 'Pistoleiro Dourado', 'Pistoleiro de Gelo', 'Lendário: Pistoleiro Lendário'],
  templar:       ['Templário Sagrado', 'Templário de Fogo', 'Templário Sombrio', 'Templário de Gelo', 'Templário Dourado', 'Lendário: Guardião Divino'],
  warlock:       ['Bruxo Sombrio', 'Bruxo de Sangue', 'Bruxo Carmesim', 'Bruxo Verde', 'Bruxo Ancião', 'Lendário: Senhor das Maldições'],
  valkyrie:      ['Valquíria Divina', 'Valquíria de Gelo', 'Valquíria Sombria', 'Valquíria Carmesim', 'Valquíria Dourada', 'Lendário: Valquíria Celestial'],
  chronomancer:  ['Cronomante Vazio', 'Cronomante Eclipse', 'Cronomante Solar', 'Cronomante Glacial', 'Cronomante Ancião', 'Lendário: Mestre do Tempo'],
  beastmaster:   ['Domador Selvagem', 'Domador de Fogo', 'Domador Glacial', 'Domador Sombrio', 'Domador Real', 'Lendário: Senhor das Feras'],
}
...
function drawSkinAura(ctx: CanvasRenderingContext2D, kind: SkinAura, frame: number) {
  ...
  const colors: Record<SkinAura, string> = {
    ...
    legendary: `rgba(255,215,0,${0.5 * pulse})`,
  }
  ctx.save()
  ...
  // Legendary aura: extra sparkle particles
  if (kind === 'legendary') {
    for (let i = 0; i < 6; i++) {
      const ang = (frame * 0.03 + i * Math.PI / 3) % (Math.PI * 2)
      const r = 14 + Math.sin(frame * 0.06 + i) * 3
      const sx = 16 + Math.cos(ang) * r
      const sy = 18 + Math.sin(ang) * r
      ctx.fillStyle = `rgba(255,255,180,${0.4 + Math.sin(frame * 0.1 + i) * 0.3})`
...
function drawSkinAccessory(ctx: CanvasRenderingContext2D, kind: SkinAccessory, frame: number) {
  ...
  switch (kind) {
    ...
    case 'legendary-crown': {
      // Coroa dourada elaborada com gemas e pontas
      const bob = Math.sin(frame * 0.08) * 0.5
      ctx.fillStyle = '#ffd700'
      ctx.fillRect(9, 4, 14, 3)
      ctx.fillRect(9, 2, 2, 3); ctx.fillRect(12, 1, 2, 4); ctx.fillRect(15, 0, 2, 5); ctx.fillRect(18, 1, 2, 4); ctx.fillRect(21, 2, 2, 3)
      // Gemas
      ctx.fillStyle = '#ff3060'; ctx.fillRect(15, 2, 2, 2)
      ctx.fillStyle = '#30ff60'; ctx.fillRect(12, 3, 1, 1); ctx.fillRect(20, 3, 1, 1)
      // Brilho pulsante
      ctx.fillStyle = `rgba(255,255,200,${0.3 + Math.abs(Math.sin(frame * 0.05)) * 0.3})`
      ctx.fillRect(9, 4, 14, 1)
      // Ombreiras lendárias
      ctx.fillStyle = '#ffd700'
      ctx.fillRect(6, 13, 5, 4); ctx.fillRect(21, 13, 5, 4)
      ctx.fillStyle = '#ff3060'; ctx.fillRect(8, 14, 1, 1); ctx.fillRect(23, 14, 1, 1)
      ctx.fillStyle = `rgba(255,255,200,${0.2 + Math.abs(Math.sin(frame * 0.04)) * 0.2})`
      ctx.fillRect(6, 13, 5, 1); ctx.fillRect(21, 13, 5, 1)
      break
    }
    case 'legendary-aura': case 'legendary-wings': break
  }
  ctx.restore()
}
