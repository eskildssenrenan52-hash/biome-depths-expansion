...
export interface Monster {
  ...
  _summonedBy?: string        // id do invocador
  _chargeDamage?: boolean     // flag de dano de investida
  _kiteDx?: number            // direção de kite (x)
  _kiteDy?: number            // direção de kite (y)
  _thorns?: boolean           // reflete dano físico
}
