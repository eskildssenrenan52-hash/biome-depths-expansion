...
export const EXTENDED_MONSTERS: ExtendedMonsterDef[] = [
  ...
  // ── EXPANSÃO: 20 NOVOS MONSTROS ────────────────────────────────────────
  { id: 'ember_wraith',      name: 'Espectro de Brasa',     silhouette: 'ghost',    palette: { primary: '#ff6020', secondary: '#801010', accent: '#ffcc40', eye: '#ffffff' }, element: 'fire',      behavior: 'phaser',   biomes: ['volcano','ruins'],       baseHp: 110, baseAtk: 24, baseDef: 6, speed: 2.8, aggroRange: 220, isRanged: false, resistances: { fire: 0.8 }, weaknesses: { ice: 0.7 } },
  { id: 'glacial_mantis',     name: 'Louva-a-Deus Glacial',  silhouette: 'arachnid', palette: { primary: '#a0e0ff', secondary: '#3060a0', accent: '#ffffff', eye: '#00ffff' }, element: 'ice',       behavior: 'charger',  biomes: ['tundra','snowy_mountain'], baseHp: 95, baseAtk: 22, baseDef: 8, speed: 3.2, aggroRange: 200, isRanged: false, scale: 1.2, resistances: { ice: 0.7 }, weaknesses: { fire: 0.6 } },
  { id: 'thunder_vulture',    name: 'Urubu do Trovão',       silhouette: 'flying',   palette: { primary: '#c0a040', secondary: '#604020', accent: '#ffff80', eye: '#ff0000' }, element: 'lightning', behavior: 'kiter',    biomes: ['desert','sky'],          baseHp: 70, baseAtk: 20, baseDef: 5, speed: 3.4, aggroRange: 240, isRanged: true,  attackRange: 260, resistances: { lightning: 0.6 } },
  { id: 'bog_troll',          name: 'Troll do Pântano',      silhouette: 'colossus', palette: { primary: '#406030', secondary: '#203020', accent: '#80a040', eye: '#ff8000' }, element: 'poison',    behavior: 'tank',     biomes: ['swamp','deep_forest'],  baseHp: 240, baseAtk: 26, baseDef: 16, speed: 1.0, aggroRange: 170, isRanged: false, scale: 1.7, resistances: { poison: 0.8, physical: 0.3 }, weaknesses: { fire: 0.6 } },
  { id: 'crystal_lizard',     name: 'Lagarto de Cristal',    silhouette: 'beast',    palette: { primary: '#c080ff', secondary: '#6040a0', accent: '#ffffff', eye: '#00ffff' }, element: 'arcane',    behavior: 'charger',  biomes: ['crystal','underdark'],   baseHp: 80, baseAtk: 18, baseDef: 10, speed: 3.0, aggroRange: 180, isRanged: false, resistances: { arcane: 0.6, physical: 0.3 } },
  { id: 'doom_serpent',       name: 'Serpente da Perdição',  silhouette: 'serpent',  palette: { primary: '#400060', secondary: '#200030', accent: '#ff00ff', eye: '#ffff00' }, element: 'shadow',    behavior: 'phaser',   biomes: ['abyss','dungeon'],       baseHp: 150, baseAtk: 26, baseDef: 10, speed: 2.8, aggroRange: 210, isRanged: false, scale: 1.4, resistances: { shadow: 0.7 }, weaknesses: { holy: 0.8 } },
  { id: 'sun_priest',         name: 'Sacerdote Solar',       silhouette: 'humanoid', palette: { primary: '#ffd040', secondary: '#a07020', accent: '#ffffff', eye: '#ffff80' }, element: 'holy',      behavior: 'healer',   biomes: ['ruins','ancient_ruins'], baseHp: 85, baseAtk: 16, baseDef: 6, speed: 2.0, aggroRange: 220, isRanged: true,  attackRange: 220, resistances: { holy: 0.8, shadow: 0.5 } },
  { id: 'iron_beetle',        name: 'Besouro de Ferro',       silhouette: 'insect',    palette: { primary: '#606060', secondary: '#303030', accent: '#a0a0a0', eye: '#ff4000' }, element: 'physical',  behavior: 'tank',     biomes: ['underdark','desert'],    baseHp: 130, baseAtk: 18, baseDef: 18, speed: 1.2, aggroRange: 150, isRanged: false, scale: 1.2, resistances: { physical: 0.6 }, weaknesses: { lightning: 0.5 } },
  { id: 'frost_phantom',      name: 'Fantasma de Gelo',       silhouette: 'ghost',    palette: { primary: '#b0e0ff', secondary: '#4060a0', accent: '#ffffff', eye: '#80ffff' }, element: 'ice',       behavior: 'kiter',    biomes: ['tundra','graveyard'],    baseHp: 75, baseAtk: 20, baseDef: 4, speed: 2.6, aggroRange: 230, isRanged: true,  attackRange: 240, resistances: { ice: 0.7, physical: 0.4 }, weaknesses: { fire: 0.7 } },
  { id: 'lava_beetle',        name: 'Besouro de Lava',        silhouette: 'insect',    palette: { primary: '#ff4020', secondary: '#801000', accent: '#ffcc00', eye: '#ffff00' }, element: 'fire',      behavior: 'swarmer',  biomes: ['volcano'],               baseHp: 35, baseAtk: 12, baseDef: 4, speed: 3.2, aggroRange: 150, isRanged: false, resistances: { fire: 0.8 }, weaknesses: { ice: 0.7 } },
  { id: 'shadow_hound',       name: 'Cão Sombrio',            silhouette: 'beast',    palette: { primary: '#1a0a20', secondary: '#0a0410', accent: '#600080', eye: '#ff00ff' }, element: 'shadow',    behavior: 'charger',  biomes: ['abyss','graveyard','dungeon'], baseHp: 90, baseAtk: 24, baseDef: 6, speed: 3.8, aggroRange: 220, isRanged: false, resistances: { shadow: 0.7 }, weaknesses: { holy: 0.8 } },
  { id: 'storm_wolf',         name: 'Lobo da Tempestade',     silhouette: 'beast',    palette: { primary: '#6080a0', secondary: '#304060', accent: '#ffff80', eye: '#00ffff' }, element: 'lightning', behavior: 'charger',  biomes: ['sky','forest'],          baseHp: 100, baseAtk: 22, baseDef: 7, speed: 3.6, aggroRange: 210, isRanged: false, resistances: { lightning: 0.6 } },
  { id: 'ancient_golem',      name: 'Golem Ancestral',        silhouette: 'construct',palette: { primary: '#807060', secondary: '#403830', accent: '#c0a080', eye: '#ff6000' }, element: 'physical',  behavior: 'tank',     biomes: ['ancient_ruins','ruins'], baseHp: 300, baseAtk: 28, baseDef: 24, speed: 0.8, aggroRange: 160, isRanged: false, scale: 1.8, resistances: { physical: 0.6, fire: 0.4 }, weaknesses: { lightning: 0.6 } },
  { id: 'plague_rats',        name: 'Ratos da Peste',         silhouette: 'beast',    palette: { primary: '#604030', secondary: '#302020', accent: '#80a040', eye: '#ff0000' }, element: 'poison',    behavior: 'swarmer',  biomes: ['city','graveyard','dungeon'], baseHp: 22, baseAtk: 8, baseDef: 2, speed: 3.4, aggroRange: 140, isRanged: false, resistances: { poison: 0.9 } },
  { id: 'void_crawler',       name: 'Rastejador do Vazio',    silhouette: 'arachnid', palette: { primary: '#200040', secondary: '#100020', accent: '#8000ff', eye: '#ff00ff' }, element: 'shadow',    behavior: 'swarmer',  biomes: ['abyss','underdark'],     baseHp: 55, baseAtk: 16, baseDef: 5, speed: 3.0, aggroRange: 170, isRanged: false, resistances: { shadow: 0.6 }, weaknesses: { holy: 0.7 } },
  { id: 'coral_golem',        name: 'Golem de Coral',         silhouette: 'construct',palette: { primary: '#ff6080', secondary: '#a02040', accent: '#ffff80', eye: '#00ffff' }, element: 'physical',  behavior: 'tank',     biomes: ['ocean'],                 baseHp: 200, baseAtk: 22, baseDef: 18, speed: 1.0, aggroRange: 150, isRanged: false, scale: 1.5, resistances: { physical: 0.5, ice: 0.4 }, weaknesses: { lightning: 0.6 } },
  { id: 'ember_bat',          name: 'Morcego de Brasa',       silhouette: 'flying',   palette: { primary: '#ff4020', secondary: '#801000', accent: '#ffcc00', eye: '#ffff00' }, element: 'fire',      behavior: 'swarmer',  biomes: ['volcano','dungeon'],     baseHp: 30, baseAtk: 10, baseDef: 2, speed: 3.8, aggroRange: 160, isRanged: false, resistances: { fire: 0.7 }, weaknesses: { ice: 0.7 } },
  { id: 'mist_walker',        name: 'Andarilho da Névoa',     silhouette: 'ghost',    palette: { primary: '#c0c0d0', secondary: '#606080', accent: '#ffffff', eye: '#8080ff' }, element: 'arcane',    behavior: 'phaser',   biomes: ['swamp','forest','graveyard'], baseHp: 65, baseAtk: 18, baseDef: 4, speed: 2.4, aggroRange: 200, isRanged: false, resistances: { physical: 0.5, arcane: 0.4 }, weaknesses: { holy: 0.6 } },
  { id: 'obsidian_gargoyle',  name: 'Gárgula de Obsidiana',   silhouette: 'construct',palette: { primary: '#1a1a2a', secondary: '#0a0a14', accent: '#ff4000', eye: '#ff8000' }, element: 'physical',  behavior: 'turret',   biomes: ['ruins','tower','city'],  baseHp: 170, baseAtk: 22, baseDef: 20, speed: 0.4, aggroRange: 240, isRanged: true,  attackRange: 260, scale: 1.3, resistances: { physical: 0.5, fire: 0.5 }, weaknesses: { lightning: 0.6 } },
  { id: 'blood_elemental',    name: 'Elemental de Sangue',    silhouette: 'elemental',palette: { primary: '#c00020', secondary: '#600010', accent: '#ff4060', eye: '#ffff00' }, element: 'shadow',    behavior: 'berserk',  biomes: ['abyss','dungeon','graveyard'], baseHp: 120, baseAtk: 26, baseDef: 6, speed: 2.6, aggroRange: 190, isRanged: false, resistances: { shadow: 0.6, physical: 0.3 }, weaknesses: { holy: 0.8 } },

  // ── 10 NOVOS TIPOS DE INIMIGOS — cada um com ataque e habilidade únicos ──
  // 1. Tempestade Viva — elemental de raio que dispara raios em cadeia (ranged turret)
  { id: 'living_tempest',   name: 'Tempestade Viva',     silhouette: 'elemental', palette: { primary: '#a0c0ff', secondary: '#4060a0', accent: '#ffff80', eye: '#00ffff' }, element: 'lightning', behavior: 'turret',   biomes: ['sky','tundra'],          baseHp: 130, baseAtk: 24, baseDef: 8, speed: 0.8, aggroRange: 280, isRanged: true, attackRange: 300, resistances: { lightning: 0.9 }, weaknesses: { ice: 0.5 }, scale: 1.3 },
  // 2. Carniçal Coral — besta marinha que drena vida no ataque corpo-a-corpo (charger com lifesteal)
  { id: 'coral_ghoul',      name: 'Carniçal Coral',      silhouette: 'beast',     palette: { primary: '#ff5070', secondary: '#a02040', accent: '#80ffe0', eye: '#00ffff' }, element: 'poison',    behavior: 'charger',  biomes: ['ocean','swamp'],        baseHp: 110, baseAtk: 22, baseDef: 8, speed: 3.4, aggroRange: 200, isRanged: false, resistances: { poison: 0.8, ice: 0.4 }, weaknesses: { lightning: 0.6 }, scale: 1.2 },
  // 3. Guardião de Âmbar — construto que reflete dano físico (tank com thorns)
  { id: 'amber_warden',     name: 'Guardião de Âmbar',   silhouette: 'construct',  palette: { primary: '#ffa020', secondary: '#804010', accent: '#ffe080', eye: '#ff0000' }, element: 'physical',  behavior: 'tank',     biomes: ['ancient_ruins','desert'], baseHp: 250, baseAtk: 20, baseDef: 24, speed: 0.8, aggroRange: 160, isRanged: false, scale: 1.5, resistances: { physical: 0.7, fire: 0.4 }, weaknesses: { lightning: 0.7 } },
  // 4. Broodmother — aranha-mãe que invoca filhotes (summoner)
  { id: 'broodmother',      name: 'Mãe-Ninho',          silhouette: 'arachnid',  palette: { primary: '#400020', secondary: '#200010', accent: '#80ff40', eye: '#ff0080' }, element: 'poison',    behavior: 'summoner', biomes: ['forest','underdark','swamp'], baseHp: 200, baseAtk: 18, baseDef: 12, speed: 1.4, aggroRange: 200, isRanged: true, attackRange: 220, scale: 1.6, resistances: { poison: 0.9 }, weaknesses: { fire: 0.7 } },
  // 5. Espectro Eco — fantasma que clona a si mesmo ao ser atingido (phaser com clone)
  { id: 'echo_specter',     name: 'Espectro Eco',       silhouette: 'ghost',     palette: { primary: '#c0c0e0', secondary: '#6060a0', accent: '#ffffff', eye: '#8080ff' }, element: 'arcane',    behavior: 'phaser',   biomes: ['ruins','graveyard','abyss'], baseHp: 85, baseAtk: 20, baseDef: 4, speed: 3.0, aggroRange: 220, isRanged: false, resistances: { physical: 0.6, arcane: 0.5 }, weaknesses: { holy: 0.8 } },
  // 6. Colosso de Brasa — gigante de fogo que causa dano em área ao redor (berserk com AoE)
  { id: 'ember_colossus',   name: 'Colosso de Brasa',   silhouette: 'colossus',  palette: { primary: '#ff4010', secondary: '#601000', accent: '#ffcc00', eye: '#ffffff' }, element: 'fire',      behavior: 'berserk',  biomes: ['volcano'],              baseHp: 300, baseAtk: 30, baseDef: 14, speed: 1.6, aggroRange: 180, isRanged: false, scale: 1.9, resistances: { fire: 0.9, physical: 0.3 }, weaknesses: { ice: 0.8 } },
  // 7. Sábio Podre — humanoide que amaldiçoa o jogador (kiter com debuff)
  { id: 'rot_sage',         name: 'Sábio Podre',        silhouette: 'humanoid',  palette: { primary: '#506020', secondary: '#203010', accent: '#a0ff40', eye: '#ffff00' }, element: 'poison',    behavior: 'kiter',    biomes: ['swamp','deep_forest'],  baseHp: 100, baseAtk: 22, baseDef: 6, speed: 2.4, aggroRange: 240, isRanged: true, attackRange: 260, resistances: { poison: 0.9, nature: 0.5 }, weaknesses: { fire: 0.7 } },
  // 8. Lobo Prisma — fera que dispara raios prismáticos (charger com beam)
  { id: 'prism_wolf',       name: 'Lobo Prisma',        silhouette: 'beast',     palette: { primary: '#ff80ff', secondary: '#4040a0', accent: '#80ffff', eye: '#00ffff' }, element: 'arcane',    behavior: 'charger',  biomes: ['crystal','sky'],        baseHp: 95, baseAtk: 24, baseDef: 6, speed: 3.8, aggroRange: 220, isRanged: false, resistances: { arcane: 0.7 }, weaknesses: { physical: 0.4 } },
  // 9. Sentinel Gélido — construto que congela o jogador ao atacar (turret com freeze)
  { id: 'frost_sentinel',   name: 'Sentinel Gélido',    silhouette: 'construct', palette: { primary: '#80c0ff', secondary: '#204060', accent: '#ffffff', eye: '#00ffff' }, element: 'ice',       behavior: 'turret',   biomes: ['tundra','snowy_mountain'], baseHp: 180, baseAtk: 22, baseDef: 20, speed: 0.6, aggroRange: 260, isRanged: true, attackRange: 280, scale: 1.3, resistances: { ice: 0.9, physical: 0.4 }, weaknesses: { fire: 0.7 } },
  // 10. Devorador de Runas — serpente que silencia habilidades do jogador (phaser com silence)
  { id: 'rune_devourer',    name: 'Devorador de Runas', silhouette: 'serpent',   palette: { primary: '#6040a0', secondary: '#201040', accent: '#ff80ff', eye: '#ffff00' }, element: 'arcane',    behavior: 'phaser',   biomes: ['crystal','ancient_ruins','tower'], baseHp: 140, baseAtk: 26, baseDef: 10, speed: 2.8, aggroRange: 220, isRanged: false, scale: 1.4, resistances: { arcane: 0.8, shadow: 0.5 }, weaknesses: { physical: 0.5 } },
]
